...
def LaB13():
    ...
    # надпись 1
    text = tk.Label(window, text="Введите город\n на английском", font=("Geometria Medium", 26),fg="dodgerblue", pady=4)
    text.pack(fill="x")

    # надпись 2
    text2 = tk.Label(window, text="например, Saint Petersburg", font=("Geometria", 11), fg="dodgerblue",pady=4)
    text2.pack(fill="x")
