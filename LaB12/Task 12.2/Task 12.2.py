...
def lab_12_2():
    ...
    text_brand = tk.Label(frame, text=ice1.name, font=("Consolas", 40, "bold"),fg="teal",bg="MintCream")
    text_brand.pack(side="top", anchor="nw")
    # стиль и расположение рейтинга магазина
    text_rate = tk.Label(frame, text=f"Рейтинг: {ice1.rate}", font=("Consolas", 16), bg="turquoise")
    text_rate.pack(side="top", anchor="nw")
    # стиль и расположение часов работы магазина
    text_time = tk.Label(frame,text=f"Время работы: {ice1.work_start_at}-{ice1.work_end_at}",font=("Consolas", 12),fg="teal",bg="MintCream")
    text_time.pack(side="bottom", anchor="sw")
    # стиль и расположение местонахождения магазина
    text_location = tk.Label(frame,text=f"Место: {ice1.location}",font=("Consolas", 12),fg="teal",bg="MintCream")
